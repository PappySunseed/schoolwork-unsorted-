...
{	
	...
	//initialization
		...
		private Rectangle db = new Rectangle();		//drag box 
		
		//mouse points 
		//Point m1.setLocation(0,0);
...
//null layout methods, window size, button layout 
	...
	public void componentResized(ComponentEvent e)
	{
		...
		r.setBounds(Obj.getOne(0));
		int mr = r.x+r.width;
		int mb = r.y + r.height;
		
		for(int i = 0; i < Obj.vector.size(); i++) 
		{
		    r.setBounds(Obj.getOne(i));
...
//scrollbar adjustments 
	public void adjustmentValueChanged(AdjustmentEvent e) 
	{
		...
		if(sb == ObjSizeScrollBar)
		{
			...
			{
				Rectangle t = new Rectangle(Obj.getOne(i)); 
