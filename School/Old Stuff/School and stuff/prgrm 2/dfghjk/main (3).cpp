		...
		case 1:
			...
			{	//Allows the user to continue entering variables until finished.
				while (userOptionTwo == 'y')
				{
					cout << "Enter Number: ";
					cin >> userEntry;
					list1.insert(userEntry);		//This will put user entries into the dynamic array
					cout << "Would you like to enter a number? (y/n) ";
					cin >> userOptionTwo;
				}
			}
			...
			{
				cout << "Invalid entry. Stopping program." << endl;
				break;
			}
		...
		case 2:
			...
			{	//Allows the user to continue entering variables until finished.
				while (userOptionTwo == 'y')
				{
					cout << "Enter Number: ";
					cin >> userEntry;
					sort1.insert(userEntry);		//This will put user entries into the dynamic array
					cout << "Would you like to enter a number? (y/n) ";
					cin >> userOptionTwo;
				}
			}
