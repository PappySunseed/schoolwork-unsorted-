...
import emporia.mathbeans.*;
import emporia.mathtools.Expr;
import emporia.mathtools.Graphable;
import java.beans.PropertyEditorSupport;
import emporia.mathtools.MathFunction;
import java.beans.SimpleBeanInfo;
import emporia.mathbeans.MathGrapher;
...
private String getProperty(Properties property, String key, String def)
{
  ...
  public SpatterApplication() throws Exception {
    ...
    graph.setGridLines(emporia.mathbeans.MathGrapher.GRIDOFF);
